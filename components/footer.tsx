...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#1a3c61] text-white overflow-hidden" role="contentinfo">
      {/* Background Image */}
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[#1a3c61]/40"></div>
      </div>
      ...
      <div className="relative z-10">
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "url": "https://khannaandassociates.in",
            "sameAs": [
        ...
        <div className="py-12">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div itemScope itemType="https://schema.org/LegalService">
                ...
                <div className="flex items-center mb-3">
                  ...
                  <a href="mailto:info@khannaandassociates.in" className="text-sm hover:text-[#4BB4E6]" itemProp="email">
                    ...
                    <ul className="space-y-1">
                      {areas.map((area, index) => (
                        <li key={index}>
                          <Link 
                            href={area.path} 
                            className="text-sm opacity-90 hover:opacity-100 hover:text-[#4BB4E6] transition-colors"
                            title={area.title}
                          >
                            {area.name}
                          </Link>
              ...
              <div>
                ...
                <div className="flex space-x-4 mb-6" role="list">
                  <a
                    ...
                    className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center hover:bg-[#4BB4E6] transition-colors"
                ...
                <nav aria-label="Quick Links">
                  ...
                  <ul className="space-y-2">
                    <li>
                      <Link 
                        href="/firm-profile" 
                        className="opacity-90 hover:opacity-100 hover:text-[#4BB4E6] text-sm transition-colors"
            ...
            <section className="mt-8 pt-8 border-t border-white/30 text-xs opacity-90 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" aria-label="Location Specific Legal Services">
              <article>
            ...
            <div className="border-t border-white/30 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
              ...
              <nav className="flex space-x-4 text-sm opacity-90" aria-label="Legal Information">
