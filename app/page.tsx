        ...
        <div className="container mx-auto px-4 py-24 relative z-10">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button className="bg-[#4BB4E6] hover:bg-[#3a9fd1] text-white px-8 py-6 text-lg" onClick={alert}
              >
      ...
      <section id="services" className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4 text-[#1a3c61]">Our Practice Areas</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Khanna and Associates offers comprehensive legal services across multiple practice areas, providing expert
              counsel to individuals and businesses alike.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.slice(0, 6).map((service, index) => (
              <Link href={`/services/${service.toLowerCase().replace(/\s+/g, "-").replace(/&/g, "and")}`} key={index}>
                <ServiceCard title={service} standalone={false} />
              </Link>
            ))}
          </div>
          ...
          <div className="text-center mt-10">
            <Link href="/services">
              <Button className="bg-[#1a3c61] hover:bg-[#132e4a] text-white px-6">View All Practice Areas</Button>
            </Link>
          </div>
        </div>
      </section>
