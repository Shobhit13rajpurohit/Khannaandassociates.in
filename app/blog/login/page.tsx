  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (email === "admin@khannaandassociates.com" && password === "admin123") {
        ...
        localStorage.setItem("blogAuthToken", "demo-token-123")
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-[#1a3c61]">Blog Admin Login</h2>
        <p className="mt-2 text-center text-sm text-gray-600">Sign in to access the blog management system</p>
      </div>
